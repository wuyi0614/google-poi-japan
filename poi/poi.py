# Codes for Odakyu project in terms of POI categorisation
#
...
if __name__ == '__main__':
    ...
    uni_cate.to_excel(save / f'poi-category-count-{get_timestamp()}.xlsx', index=False)
    ...
    opt_poi_file = save / 'optimal-poi-categorised.xlsx'
